...
function admin_header(string $title = 'Painel') {
  ...
  $adminCss = function_exists('asset_url') ? asset_url('assets/admin.css') : 'assets/admin.css';
  $adminJs = function_exists('asset_url') ? asset_url('assets/admin.js') : 'assets/admin.js';
  ...
  echo '  <link href="'.$adminCss.'" rel="stylesheet">';
  echo '  <script defer src="'.$adminJs.'"></script>';
  echo '</head>';
