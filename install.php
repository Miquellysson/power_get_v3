...
try {
  ...
  $tables_columns = [
    'products'        => ['category_id','slug','square_payment_link','stripe_payment_link','active','featured','meta_title','meta_description','updated_at','shipping_cost','price_compare'],
    'customers'       => ['first_name','last_name','address2','city','state','zipcode','country'],
    'orders'          => ['shipping_cost','total','payment_status','admin_viewed','notes','updated_at','track_token','delivery_method_code','delivery_method_label','delivery_method_details'],
    'page_layouts'    => ['meta'],
