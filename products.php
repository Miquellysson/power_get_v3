...
if ($isSuperAdmin) {
  ...
  echo '  <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm(\'Excluir definitivamente os itens selecionados?\')"><i class="fa-solid fa-trash-can mr-2"></i>Excluir selecionados</button>';
  echo '</div>';
}
echo '</form></div>';
echo '<script>
